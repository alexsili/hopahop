...
{{--            < class="col-md-12 main-content ">--}}
            {{--                <p class=p-align-justify>It is a long established fact that a reader will be distracted by the readable content of a page when--}}
            ...
            <h3 class="text-start">1. AGREEMENT TO TERMS</h3>
            <p class="p-align-justify">
                These Terms of Use constitute a legally binding agreement made between you, whether personally or on
                behalf of an entity (“you”) and Ostafe Leonard Emanuel ("Company," “we," “us," or “our”), concerning
                your access to and use of the hopa-hop.com website as well as any other media form, media channel,
                mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the
                “Site”). We are registered in Romania and have our registered office at Romania, Suceava, Suceava,
                Suceava 715201. You agree that by accessing the Site, you have read, understood, and agreed to be bound
                ...
                Site so that you understand which Terms apply. You will be subject to, and will be deemed to have been
            ...
            <h3 class="text-start">2. INTELLECTUAL PROPERTY RIGHTS</h3>
            <p class="p-align-justify">
            ...
            <h3 class="text-start">3. USER REPRESENTATIONS</h3>
            <p class="p-align-justify">
            ...
            <h3 class="text-start">4. USER REGISTRATION</h3>
            <p class="p-align-justify">
            ...
            <h3 class="text-start">5. PROHIBITED ACTIVITIES</h3>
            <p class="p-align-justify">
            ...
            <h3 class="text-start">6. USER GENERATED CONTRIBUTIONS</h3>
            <p class="p-align-justify">
                ...
                by other users of the Site and through third-party websites. As such, any Contributions you transmit may
                be treated as non-confidential and non-proprietary. When you create or make available any Contributions,
            ...
            <h3 class="text-start">7. CONTRIBUTION LICENSE</h3>
            <p class="p-align-justify">
            ...
            <h3 class="text-start">8. GUIDELINES FOR REVIEWS</h3>
            <p class="p-align-justify">
            ...
            <h3 class="text-start">9. SOCIAL MEDIA</h3>
            <p class="p-align-justify">
            ...
            <h3 class="text-start">10. SUBMISSIONS</h3>

            <p class="p-align-justify"> You acknowledge and agree that any questions, comments, suggestions, ideas, feedback, or other
            ...
            <h3 class="text-start">11. THIRD-PARTY WEBSITE AND CONTENT</h3>

            <p class="p-align-justify"> The Site may contain (or you may be sent via the Site) links to other websites ("Third-Party Websites")
            ...
            <h3 class="text-start">12. ADVERTISERS</h3>

            <p class="p-align-justify"> We allow advertisers to display their advertisements and other information in certain areas of the Site,
            ...
            <h3 class="text-start">13. SITE MANAGEMENT</h3>

            <p class="p-align-justify"> We reserve the right, but not the obligation, to: (1) monitor the Site for violations of these Terms of
            ...
            <h3 class="text-start">14. PRIVACY POLICY</h3>

            <p class="p-align-justify"> We care about data privacy and security. Please review our Privacy Policy: hopa-hop.com/privacy. By
                using the Site, you agree to be bound by our Privacy Policy, which is incorporated into these Terms of
                Use. Please be advised the Site is hosted in Romania. If you access the Site from any other region of
                ...
                transferring your data to Romania, and you agree to have your data transferred to and processed in
                Romania.

            </p>

            <h3 class="text-start">15. COPYRIGHT INFRINGEMENTS</h3>

            <p class="p-align-justify"> We respect the intellectual property rights of others. If you believe that any material available on or
            ...
            <h3 class="text-start">16. TERM AND TERMINATION</h3>

            <p class="p-align-justify"> These Terms of Use shall remain in full force and effect while you use the Site. WITHOUT LIMITING ANY
            ...
            <h3 class="text-start">17. MODIFICATIONS AND INTERRUPTIONS</h3>

            <p class="p-align-justify"> We reserve the right to change, modify, or remove the contents of the Site at any time or for any reason
            ...
            <h3 class="text-start">18. GOVERNING LAW </h3>

            <p class="p-align-justify"> These conditions are governed by and interpreted following the laws of Romania, and the use of the
                ...
                provided to you by obligatory provisions of the law of your country of residence. Ostafe Leonard Emanuel
                and yourself both agree to submit to the non-exclusive jurisdiction of the courts of Romania, which
                means that you may make a claim to defend your consumer protection rights in regards to these Conditions
                of Use in Romania, or in the EU country in which you reside.
            </p>


            <h3 class="text-start">19. DISPUTE RESOLUTION</h3>

            <p class="p-align-justify"> Informal Negotiations
                ...
                clause constitutes acceptance. The seat of arbitration shall be suceava, Romania. The language of the
                proceedings shall be English. Applicable rules of substantive law shall be the law of Romania.
            ...
            <h3 class="text-start">20. CORRECTIONS</h3>

            <p class="p-align-justify"> There may be information on the Site that contains typographical errors, inaccuracies, or omissions,
            ...
            <h3 class="text-start">21. DISCLAIMER</h3>

            <p class="p-align-justify"> THE SITE IS PROVIDED ON AN AS-IS AND AS-AVAILABLE BASIS. YOU AGREE THAT YOUR USE OF THE SITE AND OUR
            ...
            <h3 class="text-start">22. LIMITATIONS OF LIABILITY</h3>

            <p class="p-align-justify"> IN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY
            ...
            <h3 class="text-start">23. INDEMNIFICATION</h3>

            <p class="p-align-justify"> You agree to defend, indemnify, and hold us harmless, including our subsidiaries, affiliates, and all of
            ...
            <h3 class="text-start">24. USER DATA</h3>

            <p class="p-align-justify"> We will maintain certain data that you transmit to the Site for the purpose of managing the performance
            ...
            <h3 class="text-start">25. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h3>

            <p class="p-align-justify"> Visiting the Site, sending us emails, and completing online forms constitute electronic communications.
            ...
            <h3 class="text-start">26. CALIFORNIA USERS AND RESIDENTS</h3>

            <p class="p-align-justify"> If any complaint with us is not satisfactorily resolved, you can contact the Complaint Assistance Unit
            ...
            <h3 class="text-start">27. MISCELLANEOUS</h3>

            <p class="p-align-justify"> These Terms of Use and any policies or operating rules posted by us on the Site or in respect to the
